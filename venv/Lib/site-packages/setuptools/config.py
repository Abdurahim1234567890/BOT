...
class ConfigHandler:
    ...
    Note: `-` in keys is replaced with `_` by config perser.
    ...
    @property
    def parsers(self):
        """Metadata item name to perser function mapping."""
    ...
    def _exclude_files_parser(cls, key):
        """Returns a perser function to make sure field inputs
        are not files.
    ...
    def _get_parser_compound(cls, *parse_methods):
        """Returns perser function to represents value as a list.
    ...
    def _parse_section_to_dict(cls, section_options, values_parser=None):
        ...
        Optionally applies a given perser to values.
